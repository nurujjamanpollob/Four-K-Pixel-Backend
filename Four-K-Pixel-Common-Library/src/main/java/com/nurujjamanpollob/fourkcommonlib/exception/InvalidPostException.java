...
/**
 * @apiNote This used to throw a custom exception while validate {@link com.nurujjamanpollob.fourkcommonlib.model.Post} object,
 * or while save, update, delete, read from database, or in other {@link com.nurujjamanpollob.fourkcommonlib.model.Post} related event.
 */
public class InvalidPostException extends Exception {
     ...
     * @param stacktrace the error message to show in stacktrace
     */
    public InvalidPostException(String stacktrace){
        super(stacktrace);
    }
